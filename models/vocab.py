...
class VocabModel(db.Model):
    ...
    non_native = db.Column(db.String(50))
    ...
    def __init__(self, native, non_native, set_id, description):
        self.native = native
        self.foreign = non_native
        self.set_id = set_id
        self.level = 1
    ...
    def json(self):
        return {"native": self.native, "non_native": self.non_native, "set_id": self.set_id, "level": self.level, "description": self.description}
